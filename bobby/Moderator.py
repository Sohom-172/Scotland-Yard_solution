		...
		while (true){
			try{
				...
				*/
				...
				//System.out.println("Mod: ModEnabler Acquired");
				this.board.threadInfoProtector.acquire();
				//System.out.println("Mod: ThreadInfoLock Acquired");
				/* 
				...
				*/
				...
				if (this.board.embryo){
                  ...
                  //  System.out.println("Mod: 1 Registration permit released at line 49");
				...
				//System.out.println(String.format("Mod: totalThreads: %d, playingThreads: %d, quitThreads: %d", this.board.totalThreads,this.board.playingThreads,this.board.quitThreads));
				...
				*/
				...
				//	System.out.println("Mod: ThreadInfoLock Released");
					return ;
				}                                  
				...
				*/
				...
				//System.out.println("Mod: ReEntry Permits Released - "+ this.board.totalThreads);                                               
				this.board.registration.release(newbies);   
				//System.out.println("Mod: Registration permits Released - "+ newbies);
                //this.board.threadInfoProtector.release();
				this.board.threadInfoProtector.release() ;
				//System.out.println("Mod: ThreadInfoLock Released");
